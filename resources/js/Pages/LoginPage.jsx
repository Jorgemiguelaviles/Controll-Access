...
const LoginPage = () => {
    ...
    const handleLogin = async () => {
        ...
        setCookie('user', mensagem.data.TITOOLSTI || undefined, { maxAge: 900000 });
        ...
        if (mensagem.data && mensagem.data.TITOOLSTI) {
            encaminharPara('/Home');
        }
    };

    useEffect(() => {
        handleResize(); // Chama a fun��o de redimensionamento quando o componente � montado
    ...
    }, []); // Passa um array vazio como segundo argumento para garantir que este efeito s� seja executado uma vez
