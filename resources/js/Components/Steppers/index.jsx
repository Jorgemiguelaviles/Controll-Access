...
function Steppers3passos({ rota1, rota2, rota3, rota4, ativo1, ativo2, ativo3, ativo4 }) {
  return (
    <nav aria-label="..." className='w-100 row'>
      <ul className="pagination d-flex justify-content-between">
        ...
        <li className={classnames( { 'active': ativo4 })} style={{ borderRadius: '10px', borderColor: '#555' }}>
          <Link
            style={{
              background: '#333',
              borderColor: '#555',
