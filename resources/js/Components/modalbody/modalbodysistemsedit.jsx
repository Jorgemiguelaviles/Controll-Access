...
const Modalbodysistemsedit = ({ setVisible, visible, dadossistema, dadosacesso }) => {
    ...
    const [nomeDoSistemaOrigen, setNomeDoSistemaOrigen] = useState(dadossistema?.nome_do_sistema || '');
    const [tiposDeAcessoOrigen, setTiposDeAcessoOrigen] = useState(['']);
    ...
    useEffect(() => {
        if (dadossistema && dadosacesso.length > 0) {
            ...
            setNomeDoSistemaOrigen(dadossistema.nome_do_sistema || '');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (result.sucesso) {
                ...
                formData.append('nomeDoSistemaOrigen', nomeDoSistemaOrigen);
                formData.append('tiposDeAcessoOrigen', tiposDeAcessoOrigen);
