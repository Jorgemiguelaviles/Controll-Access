...
const Modalbodyusersedit = ({
    ...
    const [isAprovadorInit, setIsAprovadorInit] = useState(false);
    ...
    useEffect(() => {
        if (dadosuser) {
            ...
            setIsAprovador(dadosuser.AprovadorCheck || '')
            setIsAprovadorInit(dadosuser.AprovadorCheck || '')
            setmail(dadosuser.Email || '')
            setinitiactive(dadosuser.status || '')
            setPN(dadosuser.PN || '')
            setsenha('')
            console.log('isGestor', dadosuser.GestorCheck)
            console.log('isAprovador', dadosuser.AprovadorCheck)
        }
    }, [dadosuser]);
    ...
    const handleSave = async () => {
        try {
            const novoCPF = CPF.replace(/[^\dx]/gi, '');
            ...
            if (result.sucesso) {
                ...
                const data = {
                    ...
                    isAprovadorInit: isAprovadorInit,
                    PN: PN,
    ...
    const handleToggleAprovador = () => {
        setIsAprovador(prevActive => !prevActive);
    };
    ...
    return (
        <div style={{ overflowY: 'auto', maxHeight: '80vh', padding: '1rem' }}>
            ...
            <Input etiqueta={'Digite o PN'} desativado={false} input={PN} setinput={setPN} tipo={'text'} personalizacao={'PN'} subtitulo={'PN'} obrigatorio={false} />
            ...
            <Input etiqueta={'Digite o email'} desativado={!active} input={email} setinput={setmail} tipo={'email'} personalizacao={'email'} subtitulo={'email'} />
            ...
            <div className="row mb-2">
                <div className="col-auto">
                    <input
                        ...
                        type="checkbox"
                        checked={isAprovador}
                        id="flexCheckAprovador"  // ID único para o checkbox de Aprovador
                        onChange={handleToggleAprovador}
                    />
                </div>

                <div className="col-auto">
                    <label className="form-check-label" htmlFor="flexCheckAprovador">
                        Defina se é um Aprovador
                    </label>
                </div>
            </div>
            ...
            <div className="row mb-2">
                <div className="col-auto">
                    <input
                        ...
                        type="checkbox"
                        checked={isGestor}
                        id="flexCheckGestor"  // ID único para o checkbox de Gestor
                        onChange={handleToggleGestor}
                    />
                </div>
                <div className="col-auto">
                    <label className="form-check-label" htmlFor="flexCheckGestor">
